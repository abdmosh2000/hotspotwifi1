...
{						
	...
	var rv = "";
	var d_u = " ÌÊ„ ", h_u = " ”«⁄… ", m_u = " œﬁÌﬁ… ", s_u = " À«‰Ì… ";
	var d = "", h = "", m = "", s = "";
...
function arabicBytes(original)
{
	var rv;
	var int1 = original;
	var GB = " ÃÌÃ«»«Ì  ", MB = " „ÌÃ«»«Ì  ", KB = " ﬂÌ·Ê»«Ì  ", B = " »«Ì  ";
...
function arabicError(original)
{
    ...
    {
        rv = "·ﬁœ «œŒ·  «”„ «·„” Œœ„ »ÿ—Ìﬁ… €Ì— ’ÕÌÕ…° «·—Ã«¡ «·„Õ«Ê·… „—… «Œ—Ï";
    }
